...
#
# Special thanks to :
# - Pizzorni for is bogosort, isSorted and bogobogosort functions
#   https://github.com/Pizzorni/Bogo/blob/master/sort.py
...
def bogosort(lst):
    """ 
        While 'lst' is not sorted, suffle all 'lst''s elements.
        ~5 seconds for a list of 10 elements.
        ~2 minutes for a list of 11 elements.
        ~50 minutes for a list of 12 elements.
    """
...
def bogobogosort(lst):
    """ 
        While the 2 first elements of 'lst' are not sorted, suffle them.
        Then, while the 3 first elements of 'lst' are not sorted, suffle them again.
        Then, keep going until 'lst' is entirely sorted.
    """
    if len(lst) < 2:
        return lst
    cursor_position = 2
...
liste = [4, 8, 15, 16, 23, 42, 4, 8, 15, 16]
shuffle(liste)
liste = bogobogosort(liste)
